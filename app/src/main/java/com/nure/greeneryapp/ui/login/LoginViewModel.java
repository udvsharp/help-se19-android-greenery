...
public class LoginViewModel extends ViewModel {
    ...
    public void loginDataChanged(String username, String surname, String password, String role, String organization) {
        ...
        if (flag) {
            ...
            loginFormState.setValue(new LoginFormState(usernameError, surnameError, passwordError, roleError, organizationError));
        }
    ...
    public void register(String username, String surname, String password, String role, String organization) {
        Call<LoggedInUser> call = service
                .Register(new RegisterInfo(username, surname, password, role, organization));
        call.enqueue(new Callback<LoggedInUser>() {
            @Override
            public void onResponse(@NonNull Call<LoggedInUser> call, @NonNull Response<LoggedInUser> response) {
                LoggedInUser body = response.body();
